<template>
	<div class="contanier">
        ...
        <!--主体内容-->
        <el-row :span="24" class="lasdorm-main">
            <el-col :span="12" class="lasdorm-left">
            ...
            <el-col :span="12" class="lasdorm-right">
                <div class="coldr-top">
...
<script type="text/javascript">
    ...
    import api from '../../../apis/orientation/distdormitory/classDorm2.js'
	...
	export default {
        ...
        methods:{
            ...
            addDistrdom(sex){
                ...
                var stringList = [];
                //院系id
                var mainRelation = this.pageInfo.clazz.id;
                var count = 0;
                if(sex == 1){
        ...
        mounted () {
            var params = {
                ...
                profId : this.$route.query.profId,
                clazzId : this.$route.query.clazzId
            }
            api.distrDormForClazz(params).then(response =>{
                var meta = response.data.meta
                var mydata = response.data.data;
                if(meta.code == '200') {
                    console.log(mydata);
