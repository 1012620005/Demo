<template>
    <div class="container">
        ...
        <!--主体内容-->
        <el-row :span="24" class="ofaudit-main">
            <el-tabs type="border-card">
                <el-tab-pane label="学生更换本系部">
                    <ofaudit-one></ofaudit-one>  
                </el-tab-pane>
                <el-tab-pane label="学生更换其他系部">
                    <ofaudit-two></ofaudit-two>  
                </el-tab-pane>
            </el-tabs>
        </el-row>
    </div>
...
import ofauditOne from './ofauditOne.vue'
import ofauditTwo from './ofauditTwo.vue'
