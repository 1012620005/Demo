<template>
    <div class="container">
        <div class="ofaudit-box">
            ...
            <el-form ref="form" :model="form" :inline="true" class="loadform">
                ...
                <template>
                    <el-table :data="tableData" stripe style="width: 100%">
                        ...
                        <el-table-column label="操作" width="100">
                            <template slot-scope="scope">
                                <div v-if="scope.row.state == 4 && scope.row.against != 3" class="handle handhover clearfix">
                                ...
                                <div v-if="scope.row.state > 4 && scope.row.against != 3" class="handle clearfix">
                                    <span class="imgScript success"></span>
                                    已通过
                                </div>
...
export default {
    ...
    methods: {
        ...
        loadList(){
            let allList = {
                newDeptId: this.department,
                newProfId:this.form.major.id,
                grade_id: this.form.grade.id,
                newClazzId:this.form.class.clazzid,
                pageNo: this.Page.pageNo,
                pageSize: this.Page.pageSize,
            }
            api.getNewCPDEMForDept(allList).then(response => {
                if(response.data.meta.code == 200){
