<template>
  <div class="repair">
      <nav-top></nav-top>
      <p class="log-magess"><span class="arrow-center left" >审核报修</span><span class="arrow-right"  @click="back" >返回<i class="el-icon-arrow-right"></i></span></p>
          ...
          <div style="margin:0 0 20px;">
            <el-table
              ...
              <el-table-column
                ...
                width="90">
                <template slot-scope="scope">
                  <el-button  type="text" @click="creat" size="small">审核</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
...
export default {
  ...
  methods: {
    ...
    getlist(){
      ...
      'fewWeek':this.form.week.items,
      'pjType':1,
      'pageSize':10,
      'pageNo':this.page.pageNo,
    }
      AD.getTcreview(u).then(r=>{
        if(r){
