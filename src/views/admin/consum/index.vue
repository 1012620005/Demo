<template>
  <div class="Assets">
      <nav-top></nav-top>
      <div class="log-magess"><span class="arrow-center left" >低值易耗品管理</span><span class="arrow-right"  @click="back" >返回<i class="el-icon-arrow-right"></i></span></div>
      <div class="Assets-box">
        <div class="tabs">
          <ul class="tabs-items"  >
            <div ref="tabs"  @click="tabs">
              <li data-active="1" class="tabs-items-item">低值易耗品管理</li>
              <li data-active="2">报废管理</li>
            </div>
          </ul>
        </div>
        <div class="Assets-top">
          <asse-ts v-if="active == '1'" ></asse-ts>
          <scr-ap v-if="active == '2'" ></scr-ap>
        </div>
      </div>  
  </div>
</template>
