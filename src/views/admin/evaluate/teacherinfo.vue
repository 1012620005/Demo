<template>
  <div class="Assets">
      <nav-top></nav-top>
      <div class="log-magess"><span class="arrow-center left" >评价管理</span><span class="arrow-right"  @click="back" >返回<i class="el-icon-arrow-right"></i></span></div>
      <div class="Assets-box">
        <div class="tabs">
          <ul class="tabs-items"  >
            <div ref="tabs"  @click="tabs">
              <li data-active="1" class="tabs-items-item">评价管理</li>
              <li data-active="2">我的评价结果</li>
            </div>
          </ul>
        </div>
        <div class="Assets-top">
          <teacher-each v-if="active == '1'" ></teacher-each>
          <my-teacher v-if="active == '2'" ></my-teacher>
        </div>
      </div>  
  </div>
</template>
...
import teacherEach from "./teacherEach";
