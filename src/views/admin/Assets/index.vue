<template>
  <div class="Assets">
      <nav-top></nav-top>
      <div class="log-magess"><span class="arrow-center left" >物品资产管理</span><span class="arrow-right"  @click="back" >返回<i class="el-icon-arrow-right"></i></span></div>
      <div class="Assets-box">
        <div class="tabs">
          <ul class="tabs-items"  >
            <div ref="tabs"  @click="tabs">
              <li data-active="1" class="tabs-items-item">固定资产管理</li>
