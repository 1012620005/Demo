<template>
  <div class="full-calendar-body">
    <div class="todayBox">
        <div class="todayLeft">
           <span class="blockBox dayBox">{{ showDate }}</span>
           <span class="blockBox year">
              {{ showYear }}
           </span>
        </div>
        <div class="todyaRight">
            <span class="todayTip">提醒:</span>
            <span><marquee loop="infinite" style="width:160px;color:#14c3c2"><font>{{ tip }}</font></marquee></span>
        </div>
    </div>
    <div class="weeks">
...
<script type="text/babel">
  ...
  export default {
    ...
    computed : {
      ...
      showYear () {
        var yearDate =  new Date(this.currentDate).getFullYear();
        var date = new Date(this.currentDate).getMonth()  + 1;
        return yearDate + '-' + date
      },
      showDate () {
