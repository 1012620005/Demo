		...
		<div class="content">
			<!-- <div class="sLeave-top">
				<div class="sLeave-top-left">
					<span class="sLeave_title">校历管理</span>
				</div>
			...
			<div class="sLeave-bottom">
				 <el-form :inline="true" :model="formInline" class="demo-form-inline">
				 	<div  class="btnS" @click="add"><span class="btn qingjia"></span>添加校历</div>
					<div  class="fontColor label_padding">校区:</div>
				 	<el-select v-model="formInline.ssid" placeholder="校区" clearable style="width:100px;" @change="findDepart">
						<el-option v-for="t in tableData.s" :label="t.name" :value="t.id" :key="t.id" >{{t.name}}</el-option>
					</el-select>
					<div  class="fontColor label_padding">院系:</div>
				 	<el-select v-model="formInline.depart" placeholder="院系" clearable style="width:100px;"@change="findMajor" >
						<el-option v-for="t in tableData.depart" :label="t.name" :value="t.id" :key="t.id">{{t.name}}</el-option>
					</el-select>
					<div  class="fontColor label_padding">专业:</div>
				 	<el-select v-model="formInline.marjor" placeholder="专业" clearable style="width:100px;" @change="findXl">
						<el-option v-for="t in tableData.marjor" :label="t.label" :value="t.value" :key="t.value">{{t.label}}</el-option>
					</el-select>  
					<!-- <el-date-picker
				    ...
				    <el-table-column
				      ...
				      label="专业"  width="150">
						<template slot-scope="scope">
						 ...
						 <el-table-column
				      prop="eventdate"
				      label="校历时间"  width="120">
						<template slot-scope="scope">
							<span class="textCal">{{ scope.row.eventdate }}</span>
						</template>					  
				    </el-table-column>			    
				    <el-table-column
				      label="校历事件">
				      ...
				      label="操作">
				       <template slot-scope="scope">
				            <span class="imgScript seeBtn" @click="seeDetial(scope.row)"></span> 
				           	<span class="btns delete" @click="deleteDetial(scope.row)"></span> 
				      </template>
				    </el-table-column>				    			    			    
				  </el-table>
						 ...
						 <!--头部-->
						  <div class="full-calendar-header full-calendar-manage">
						    ...
						    <div class="header-right">
						      ...
						      <span class="next-month next" @click.stop="goNext"></span>
						    </div>
						  </div>
						  <!--body-->
						...
						<el-form ref="calenderForm" :model="calenderForm" label-width="60px" :rules="calenderFormRule">
							<el-form-item label="校区:" prop="campus">
							    <el-select v-model="calenderForm.sid" @change="findOffice(calenderForm.sid,'2')" placeholder="请选择校区">
							      <el-option v-for="t in calenderForm.slist" :label="t.name" :value="t.id" :key="t.id">{{t.name}}</el-option>
							    </el-select>
						    </el-form-item>
						    <el-form-item label="院系:" prop="departMan">
							    <el-select v-model="calenderForm.deptid" @change="findOffice(calenderForm.deptid,'3')" placeholder="请选择院系">
							      <el-option v-for="t in calenderForm.deptlist" :label="t.name" :value="t.id" :key="t.id">{{t.name}}</el-option>
							    </el-select>
		 					</el-form-item>
							<el-form-item label="专业:" prop="prefor">
							    <el-select v-model="calenderForm.proid" placeholder="请选择专业">
							      <el-option v-for="t in calenderForm.prolist" :label="t.name" :value="t.id" :key="t.id">{{t.name}}</el-option>
							    </el-select>
							</el-form-item> 
