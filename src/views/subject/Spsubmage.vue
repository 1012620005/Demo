<template>
    <div class="aidstu">
        ...
        <el-table :data="tableData" style="width: 100%" v-loading="loading">
            ...
            <el-table-column prop="subjectName" label="特殊学科名称">
            </el-table-column>
            <el-table-column label="操作">
                <template slot-scope="scope">
                    <div class="handle">
                        <img src="../../assets/img/overtime/edit.png" @click="editDialog(scope.row)" alt="" class="edit"> 
                        <img src="../../assets/img/overtime/del.png" @click="delDisc(scope.row.id)" alt="" alt="" class="del"> 
                    </div>
                </template>
            </el-table-column>
        </el-table> 
        ...
        <!-- 添加特殊学科弹框 -->
        <spsu-bounce :ruleForm="form" v-if="or" @close="close"></spsu-bounce> 
    </div>
</template>
<script>
    import spsuBounce from './spsubounce.vue'
    ...
    export default {
        ...
        methods:{
            ...
            getSpsuList(){
                ...
                this.loading = true;
                api.getSpsuList(para).then(response=>{
