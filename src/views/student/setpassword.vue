<template>
  <div class="setpassword">
      ...
      <div class="authentication-box">
        ...
        <el-form v-show="(active==1)?true:false" :model="ruleForm"  ref="ruleForm" label-width="85px" class="demo-ruleForm demo-ruleForm1">
          <el-form-item label="新密码" prop="name">
            <el-input size="large" v-model="ruleForm.password" placeholder="请输入密码"></el-input>
          </el-form-item>
          <el-form-item label="确认新密码" prop="name">
            <el-input size="large" v-model="ruleForm.password" placeholder="请再次输入密码"></el-input>
          </el-form-item>
          <div class="btn-box">
            <button type="button" class="btn-succeed margin-right" @click="next"><span>确定</span></button>
        ...
        <div  class="demo-ruleForm" v-show="(active==2)?true:false">
          <img src="../../assets/image/setpass-succeed.png"/>
          <div class="btn-box">
