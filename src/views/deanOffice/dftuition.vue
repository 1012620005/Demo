<template>
  <div class="dfsend">
    ...
    <!--添加免学费弹框 -->
    <el-dialog title="添加免学费" :visible.sync="dialogFormVisible">
        <el-form ref="form" :rules="rules" :model="form" :label-width="formLabelWidth">
            ...
            <el-form-item label="免学费金额：" prop="money">
                <el-input v-model="form.money"></el-input>
            </el-form-item>
            <el-form-item label="免学费来源：" prop="source">
    ...
    <!-- 免学费详情弹框 -->
    <el-dialog title="免学费详情" :visible.sync="dialogDetailVisible">
    ...
    <el-table stripe :data="tableData" style="width: 100%" v-loading="loading">
        ...
        <el-table-column prop="supportMoney" label="免学费金额" width="110">
        </el-table-column>
        <el-table-column prop="supportSource" label="免学费来源" width="110">
        </el-table-column>
    ...
    export default {
        data(){
            return {
                ...
                rules: {
                    ...
                    money: [
                        { required: true, message: '请输入免学费金额', trigger: 'change' }
                    ],
                    source: [
                        { required: true, message: '请输入免学费来源', trigger: 'change' }
                    ],
                    note: [
        ...
        methods: {
            ...
            postDfsendDetail(row){
                ...
                this.form.class = row.clazz;
                this.form.name = row.stuName;
                // this.form.counselor = row.stuName;
                this.form.money = row.supportMoney;
                this.form.source = row.supportSource;
                this.form.note = row.remarks;
