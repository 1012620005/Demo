		...
		<div class="content">
			...
			<div class="sLeave-bottom bookIndex">
                <div class="demo-form-inline">
                          ...
                          <el-select v-model="formInline.term" clearable placeholder="" class="select_width" @change="getUserList">
                               <el-option :label="item.xq" :value="item.xq" :key="item.xq" v-for="item in formInline.termList"></el-option>
                          </el-select>
                          ...
                          <el-select v-model="formInline.teachId" filterable clearable placeholder="任课老师" class="select_width" @change="getUserList">
                ...
                <el-form :inline="true" :model="formInline" class="demo-form-inline">
                            ...
                            <span @click="aduit" class="lineFlex" style="padding-bottom:5px; padding-right:8px;cursor:pointer"><span class="btn qingjia"></span><span>提交审核</span></span>
                            ...
                            <a  :href="downLoadUrl" class="lineFlex">
    ...
    <el-dialog title="授课任务安排" :visible.sync="auditForm.dialogFormVisible" size="tiny" custom-class="dialogImg" label-position="right" @close="closeAuditDialog('auditForm')">
			<div class="wrapper_dialog">
				  <el-form :inline="true" class="demo-form-inline labelPosition" :model="auditForm" :rules="rules" ref="auditForm">
                        ...
                        <el-form-item label="连排次数:" prop="classOrder">
                            <el-input type="text"  v-model="auditForm.classOrder" class="inputWidth"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="任课老师:" prop="teacherName">
                            <el-select v-model="auditForm.teacherName" filterable placeholder="" style="width:150px;" >
                                <el-option :label="item.name" :value="item.id" :key="item.id" v-for="item in formInline.teachList"></el-option>
                            </el-select>
                        </el-form-item>
                        ...
                        <el-form-item label="接替课程:">
                            <!-- <el-input type="text"  v-model="auditForm.replaceCourseid" class="inputWidth" style="width:150px;" ><i slot="suffix" class="el-input__icon el-icon-search"></i></el-input> -->
                        ...
                        <el-form-item label="单双周:">
                            <el-select v-model="auditForm.oneWeek" placeholder="" style="width:150px;" >
    ...
    export default {
        data () {
            return {
                ...
                rules:{
                    ...
                    classOrder:[{ required: true, message: '请填写连堂次数', trigger: 'change' }]
                }
            }
        },
        components:{
        ...
        methods:{
           getUserList () {
               ...
               apis.teachTaskList(data).then(res=>{
                   if(res){
           ...
           closeAuditDialog (form) {
               ...
               this.curId = ''
               this.personId = ''
               this.auditForm.replaceStart = ''
               this.auditForm.replaceEnd = ''
               this.auditForm.replaceTeaid = ''
               this.auditForm.replaceCourseid = ''
               this.auditForm.oneWeek = ''
               this.auditForm.inClass = ''
               ...
               this.$refs[form].validate((valid) => {
                    if (valid) {
                        ...
                        if(this.curClick == '修改') {
                            ...
                            apis.updateCourse(param).then((res) =>{
                                if(res){
                                    this.$message({
                                        type:'success',
                                        message:'修改成功'
           ...
           getProList () {
               ...
               apis.getClassRoom().then(res =>{
                ...
                // 获取教室场地的接口
                apis.getFieldRoom().then(res =>{
                    if(res){
                        var data = res.data.data
                        this.setForm.RoomField = data
                    }
                })
           ...
           absence (str) {
               ...
               if(len != 1) {
                ...
                if(str == '修改') {    
                        if(aduitStatus != '1' && aduitStatus != '4' && aduitStatus != '0' ) {
                            this.$message({
                                type:'error',
                                message:`只能${str}状态为"已设置未提交"和"审核不通过"和"未设置"的信息！`
                            })
                            return false
                        }
                        ...
                        console.log(obj.inClass != '' && obj.inClass != null)
                } else {
                    if(aduitStatus != '1' && aduitStatus != '4') {
                        this.$message({
                            type:'error',
                            message:`只能${str}状态为"已设置未提交"和"审核不通过"的信息！`
                        })
                        return false
                   }
                    if(str == '添加') {
                        ...
                        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                            ...
                            apis.deleteCourse(qs.stringify({id:courseId})).then(res =>{
                                if(res) {
                                    this.getUserList()
                                }
                            })
           ...
           aduit () {
               ...
               if(this.multipleSelection.some(function(obj){
                   ...
                   this.$message({
                       type:'error',
                       message:'只能审核状态为"已设置未提交"和"审核不通过"的信息'
                   })
               } else {
                   ...
                   apis.auditCourse(data).then(res =>{
                        if(res){
                            this.$message({
                                type:'success',
                                message:'提交成功'
