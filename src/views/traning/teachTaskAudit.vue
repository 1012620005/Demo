		...
		<div class="content">
			...
			<div class="sLeave-bottom bookIndex">
                ...
                <el-form :inline="true" :model="formInline" class="demo-form-inline">
                            ...
                            <span @click="aduit('pass')" class="lineFlex" style="padding-bottom:5px; padding-right:8px;cursor:pointer"><span class="btn qingjia"></span><span>审核通过</span></span>
                            <span @click="aduit('nopass')" class="lineFlex" style="padding-bottom:5px; padding-right:8px;cursor:pointer"><span class="btn qingjia"></span><span>审核不通过</span></span>
    ...
    export default {
        ...
        methods:{
           getUserList () {
               ...
               apis.getAuditList(data).then(res=>{
                   if(res){
           ...
           save (form) {
               this.$refs[form].validate((valid) => {
                    if (valid) {
                        console.log(this.auditForm.inClass)
                        let arr = []
                        ...
                        if(this.curClick == '修改') {
                            ...
                            apis.updateAudit(param).then((res) =>{
                                if(res){
                                    this.$message({
                                        type:'success',
                                        message:'修改成功'
           ...
           absence (str) {
               ...
               if(str == '添加') {
                   ...
                   this.auditForm.dialogFormVisible = true
                    ...
                    if(aduitStatus == '4' || aduitStatus == '5') {
                        this.$message({
                            type:'error',
           ...
           aduit (str) {
               ...
               if(this.multipleSelection.some(function(obj){
                   ...
                   if(str == 'pass') {
                       ...
                       apis.nopassAudit(data).then(res =>{
                        if(res){
                            this.$message({
                                type:'success',
                                message:'提交成功'
